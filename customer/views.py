...
def customer_signup_view(request):
    ...
    if request.method=='POST':
        ...
        text = ocr("home/kevin/Documents/industry_ibm_project/profile_pic/Customer/"+str(fileName)) 
        ...
        if userForm.is_valid():
            ...
            customer.profile_pic = "home/kevin/Documents/industry_ibm_project/profile_pic/Customer/"+str(fileName)
